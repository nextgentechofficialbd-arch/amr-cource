    ...
    <nav className="sticky top-0 z-50 bg-[#0F172A]/80 backdrop-blur-md border-b border-slate-800 px-4 md:px-8 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
          <Link href="/" className="hover:text-blue-400 transition-colors">হোম</Link>
          <Link href="/#courses" className="hover:text-blue-400 transition-colors">কোর্সসমূহ</Link>
          <Link href="/#about" className="hover:text-blue-400 transition-colors">আমাদের সম্পর্কে</Link>
        </div>
        ...
        <div className="flex items-center gap-4">
          {user ? (
            <>
              <Link 
                href={user.role === UserRole.ADMIN ? "/admin" : "/dashboard"}
