      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center gap-2 mb-8">
            ...
            <span className="text-3xl font-bold tracking-tight text-white">AmrCourse</span>
          </Link>
          <h1 className="text-2xl font-bold text-white">একাউন্টে লগইন করুন</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all text-white"
              />
            </div>
